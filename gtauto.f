...
c-----------------------------------------------------------------------
     ...
     &        Laccdf,Lotmod,hvdiff,Lchkmu,Lmixmd
...
c-----------------------------------------------------------------------
     ...
     &tdefaultnoautooutlierurfinalfirstarcheckmumixedrejectfcstfcstlim')
c-----------------------------------------------------------------------
      CHARACTER NOTDIC*9
      INTEGER notptr,PNOT
      PARAMETER(PNOT=2)
...
c-----------------------------------------------------------------------
     ...
     &        180,190,50,200,210,220,230),argidx
c-----------------------------------------------------------------------
