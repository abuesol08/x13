...
*     &       Rgvrtp(begcol).ne.PRGTAT.and.Rgvrtp(begcol).ne.PRGTAS.and.
     &       Rgvrtp(begcol).ne.PRGTAT.and.Rgvrtp(begcol).ne.PRGTUD.and.
*     &       numg.gt.1)THEN
*     &       Rgvrtp(begcol).ne.PRGTAT.and.Rgvrtp(begcol).ne.PRGTUS).and.
     &       Rgvrtp(begcol).ne.PRGTUS).and.numg.gt.1)THEN
          IF(lprchi)lprund=T
          endcol=Grp(igrp)-1
