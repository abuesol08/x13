...
c     ------------------------------------------------------------------
     ...
     &        ibrr,ierr,Fctdrp,Nfcst,Nbcst,Outdec
      DIMENSION Begxy(2),regeff(11),rgefpt(0:13),rgeftp(55),Ftd(PLEN),
...
c-----------------------------------------------------------------------
     ...
     &ant')
      DATA refptr/1,9,20,35,52,61,68,70,81,83,95,108,110,118/
c-----------------------------------------------------------------------
c*x12      DATA rgefpt/1,3,7,8,9,12,14,17,18/
c****      DATA rgefpt/1,3,6,8,9,12,14,17,18/
      DATA rgefpt/1,8,20,26,29,32,42,44,50,52,53,54,56,56/
      DATA rgeftp/PRGTSE,PRGTTS,PRGTUS,PRRTSE,PRRTTS,PRATSE,PRATTS,
     &            PRGTTD,PRGTST,PRRTTD,PRRTST,PRATTD,PRATST,PRG1TD,
     &            PRR1TD,PRA1TD,PRG1ST,PRR1ST,PRA1ST,PRGTSL,PRRTSL,
     &            PRATSL,PRGTLM,PRRTLM,PRATLM,PRGTLQ,PRRTLQ,PRATLQ,
     &            PRGTLY,PRRTLY,PRATLY,PRGTEA,PRGTEC,PRGTES,PRGTLD,
     &            PRGTTH,PRGTUH,PRGUH2,PRGUH3,PRGUH4,PRGUH5,PRGTAO,
     &            PRGTAA,PRGTLS,PRGTRP,PRGTAL,PRGTTL,PRGTQD,PRGTQI,
     &            PRGTTC,PRGTAT,PRGTUD,PRGTMV,PRGTSO,PRGTCN/
*     &            PRGTUD,PRGTMV,PRGTSO,PRGTAS,PRGTCN/
c-----------------------------------------------------------------------
...
c-----------------------------------------------------------------------
     ...
     &     rtype.eq.PRATSL.or.rtype.eq.PRATLQ.or.rtype.eq.PRATLY)))
...
c-----------------------------------------------------------------------
     ...
     &   (rtype.eq.PRGTAO.or.rtype.eq.PRGTAA))
...
c-----------------------------------------------------------------------
     ...
     &    rtype.eq.PRGTQD.or.rtype.eq.PRGTQI))
...
*       IF((Adjso.eq.1).and.(rtype.eq.PRGTSO.or.rtype.eq.PRGTAS))
       IF((Adjso.eq.1).and.rtype.eq.PRGTSO)
