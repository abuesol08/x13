...
c-----------------------------------------------------------------------
      IF(.not.Lnoprt)THEN
       IF(Lrvsa)THEN
        IF(.not.(Prttab(LREVR1).or.Prttab(LRVR1S).or.Prttab(LRVR1A).or.
     &           Savtab(LREVR1).or.Savtab(LRVR1S).or.Savtab(LRVR1A)))
     &     Prttab(LREVR1)=T
        IF(Iagr.ge.5.and..not.
     &    (Prttab(LREVR3).or.Prttab(LRVR3S).or.Prttab(LRVR3A).or.
     &     Savtab(LREVR3).or.Savtab(LRVR3S).or.Savtab(LRVR3A)))
     &     Prttab(LREVR3)=T
       END IF
       IF(Lrvch.and..not.
     &   (Prttab(LREVR2).or.Prttab(LRVR2S).or.Prttab(LRVR2A).or.
     &    Savtab(LREVR2).or.Savtab(LRVR2S).or.Savtab(LRVR2A)))
     &    Prttab(LREVR2)=T
       IF(Lrvtrn.and..not.
     &   (Prttab(LREVR4).or.Prttab(LRVR4S).or.Prttab(LRVR4A).or.
     &    Savtab(LREVR4).or.Savtab(LRVR4S).or.Savtab(LRVR4A)))
     &    Prttab(LREVR4)=T
       IF(Lrvtch.and..not.
     &   (Prttab(LREVR5).or.Prttab(LRVR5S).or.Prttab(LRVR5A).or.
     &    Savtab(LREVR5).or.Savtab(LRVR5S).or.Savtab(LRVR5A)))
     &    Prttab(LREVR5)=T
       IF(Lrvsf.and..not.
     &   (Prttab(LREVR6).or.Prttab(LRVR6S).or.Prttab(LRVR6A).or.
     &    Savtab(LREVR6).or.Savtab(LRVR6S).or.Savtab(LRVR6A)))
     &    Prttab(LREVR6)=T
       IF(Lrvaic.and..not.(Prttab(LREVR7).or.Savtab(LREVR7)))
     &    Prttab(LREVR7)=T
       IF(Lrvfct.and..not.(Prttab(LREVR8).or.Savtab(LREVR8).or.
     &    Prttab(LRVR8A)))Prttab(LREVR8)=T
       IF(Lrvarma.and..not.(Prttab(LRVR9A).or.Savtab(LRVR9A)))
     &    Prttab(LRVR9A)=T
       IF(Lrvtdrg.and..not.(Prttab(LRVR9B).or.Savtab(LRVR9B)))
     &    Prttab(LRVR9B)=T
      END IF
c-----------------------------------------------------------------------
...
c-----------------------------------------------------------------------
          CALL dfdate(Begspn,Begmdl,Ny,ndmdl)
