...
c-----------------------------------------------------------------------
     ...
     &        starta,enda,sspos,endcol,icol,iusr,rtype,Iyr,Im,Itd,Ihol,
...
c-----------------------------------------------------------------------
     ...
     &       rtype.eq.PRGTUS.or.rtype.eq.PRGTUD)THEN
          DO icol=begcol,endcol
           IF(rtype.eq.PRGTUD)THEN
            IF((Usrtyp(iusr).eq.PRGTTD.or.Usrtyp(iusr).eq.PRGTST))THEN
             Tdfix=Tdfix.and.Regfx(icol)
            ELSE IF(Usrtyp(iusr).eq.PRGTEA.or.Usrtyp(iusr).eq.PRGTEC
     &          .or.Usrtyp(iusr).eq.PRGTES.or.Usrtyp(iusr).eq.PRGTLD
     &          .or.Usrtyp(iusr).eq.PRGTTH)THEN
