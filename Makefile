...
binaries/windows/32/x13.exe: src/Makefile
	...
	cd tmp/windows/32;  schroot -c jessie -- make FC=i686-w64-mingw32-gfortran LINKER=i686-w64-mingw32-gfortran FFLAGS="-O2" PROGRAM=x13.exe
...
binaries/windows/64/x13.exe: src/Makefile
	...
	cd tmp/windows/64;  schroot -c jessie -- make FC=x86_64-w64-mingw32-gfortran LINKER=x86_64-w64-mingw32-gfortran FFLAGS="-O2" PROGRAM=x13.exe
