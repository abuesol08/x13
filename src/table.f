C     Last change:  BCM  16 Feb 1999    3:59 pm
...
c-----------------------------------------------------------------------
     ...
     &       (Kpart.eq.4.and.(Ktabl.eq.8.or.Ktabl.eq.10.or.Ktabl.eq.16
     &        .or.Ktabl.eq.18)))THEN
           nfct=Ny
          ELSE
           ifct=0
...
c-----------------------------------------------------------------------
     ...
     &     (Ktabl.eq.16.or.Ktabl.eq.21.or.Ktabl.eq.22))
       ...
       END DO
       IF(Muladd.eq.1)THEN
        IF((Kpart.eq.5.and.Ktabl.eq.18).or.(Ktabl.eq.17))THEN
         ipow=1
         IF((Kpart.eq.5.and.Ktabl.eq.18).and.(ldec.eq.0))ldec=3
        END IF
       ELSE
        ipow=ip(Ktabl)
