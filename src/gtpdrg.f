...
**==gtpdrg.f    processed by SPAG 4.03F  at 09:50 on  1 Mar 1994
      SUBROUTINE gtpdrg(Begsrs,Nobs,Havsrs,Havesp,X11reg,Havtd,Havhol,
...
c     -----------------------------------------------------------------
       IF(Nxtktp.eq.NAME.or.Nxtktp.eq.QUOTE)THEN
        CALL adpdrg(Begsrs,Nobs,Havsrs,Havesp,Nxttok,Nxtkln,X11reg,
     &              Havtd,Havhol,Havln,Havlp,argok,Locok)
        IF(Lfatal)RETURN
c     -----------------------------------------------------------------
