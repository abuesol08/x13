C     Last change:  BCM  23 Mar 2005    3:38 pm
      SUBROUTINE x12run(Isrs,Unopnd,Nopen,Lchkin,Lcomp,Rok,Fok,
     &                  N1,Nfail,Ldata,Dtafil,Mtafil,Nmf,Dattim,X11agr,
     &                  Lgraf,Lexgrf)
      IMPLICIT NONE
c-----------------------------------------------------------------------
...
C-----------------------------------------------------------------------
     ...
     &            lmodel,Ldata,Dtafil,hvmfil,mdlfil,Rok)
      IF(Lfatal)RETURN
C-----------------------------------------------------------------------
