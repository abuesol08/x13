C     Last change:  BCM   4 Sep 1998    1:46 pm
      SUBROUTINE addfix(Trnsrs,Nbcst,Rindex,Fxindx)
      IMPLICIT NONE
c-----------------------------------------------------------------------
...
c----------------------------------------------------------------------- 
      ...
      INTEGER i,icol,Nbcst,nchr,nchgrp,igrp,begcol,endcol,Rindex,Fxindx,
     &        nu
...
c-----------------------------------------------------------------------
     ...
     &     Fxtype(begcol).eq.PRGTUS.or.Fxtype(begcol).eq.PRGTUD)THEN
        nu=nu+1
c-----------------------------------------------------------------------
