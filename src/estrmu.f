...
c-----------------------------------------------------------------------
      ...
      DIMENSION emeans(25,2:4)
c-----------------------------------------------------------------------
      DATA(emeans(i,2),i=1,25)/
     & 0.00368D0,0.002083333D0,0.001130435D0,0.0002727273D0,0D0,
     & 0D0,0D0,0D0,0D0,0D0,
     & 0D0,0D0,0D0,0D0,0D0,
     & 0D0,0D0,0D0,0D0,0D0,
     & 0D0,0D0,0D0,0D0,0D0/
      DATA(emeans(i,3),i=1,25)/
     ...
     & 0.3304D0,0.3125D0,0.2966667D0,0.281D0,0.266D0/
      DATA(emeans(i,4),i=1,25)/
     ...
     & 0.6696D0,0.6875D0,0.7033333D0,0.719D0,0.734D0/
c-----------------------------------------------------------------------
