...
*        call profiler(3,'Pre CALCRES')
     ...
     $               rstd,rtval,wnormtes,skewne,test1,rkurt,test,
...
*        call profiler(3,'Pre ShowInvalDecomp')
 ...
 7052  format (
     ...
     $ ' TRY ANOTHER MODEL OR, FOR AN APPROXIMATION, SET NOADMISS=1.'
     $ )
 7053  format (12f11.5)
       write (Nio,7052)
CUNX#ifdef PROFILER
...
cc
     ...
     $                   test1,rkurt,test,sumSres,dw,rvar,mAuto,nfreq,
...
C.. Formal Arguments ..
      ...
      real*8 rkurt,skewne,wnormtes,test1,test
