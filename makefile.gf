...
OBJS            = aaamain.o abend.o acf.o acfar.o acfdgn.o \
                  ...
                  armats.o arspc.o automd.o automx.o avedur.o \
                  ...
                  procflts.o profiler.o prothd.o prprad.o prrvob.o \
                  ...
                  savspp.o savstp.o savtbl.o savtpk.o savwkf.o sceast.o \
                  scrmlt.o sdev.o sdxtrm.o seatad.o seatdg.o \
...
SRCS            = aaamain.f abend.f acf.f acfar.f acfdgn.f \
                  acfhdr.f addadj.f addaic.f addate.f addeas.f \
                  ...
                  armats.f arspc.f automd.f automx.f avedur.f \
                  ...
                  procflts.f profiler.f prothd.f prprad.f prrvob.f \
...
acfdgn.o:  autoq.cmn mdldat.cmn mdlsvl.i model.cmn model.prm srslen.prm \
         svllog.cmn svllog.prm units.cmn

acfhdr.o:  model.cmn model.prm notset.prm prior.cmn prior.prm srslen.prm

addadj.o:  error.cmn stdio.i units.cmn

addaic.o:  error.cmn model.prm notset.prm srslen.prm
...
analts.o:  bench.i buffers.i build.i calc.i calfor.i calshr.i count.i \
         ...
         logtrace.i nsums.i peaks.i pinno.i preadtr.i seastest.i \
...
ansub4.o:  acfast.i acfst.i bartlett.i bench.i cross.i cxfinal.i dimensions.i \
         estb.i force.i hspect.i lzero.cmn models.i preadtr.i priadj.cmn \
...
arima.o:  adj.cmn arima.cmn autoq.cmn error.cmn extend.cmn fxreg.cmn \
         hiddn.cmn inpt.cmn lkhd.cmn lzero.cmn mdldat.cmn mdlsvl.i mdltbl.i \
         missng.cmn model.cmn model.prm mq3.cmn notset.prm orisrs.cmn \
         picktd.cmn priadj.cmn prior.cmn prior.prm prittl.cmn priusr.cmn \
         rev.cmn rev.prm rho.cmn seatad.cmn spcsvl.i spctbl.i srslen.prm \
         stdio.i svllog.cmn svllog.prm tbllog.cmn tbllog.i tbllog.prm \
         tdtyp.cmn title.cmn tukey.cmn units.cmn usrreg.cmn x11fac.cmn \
         x11log.cmn x11opt.cmn x11ptr.cmn
...
editor.o:  adj.cmn agr.cmn agrsrs.cmn arima.cmn cmpsvl.i cmptbl.i dgnsvl.i \
         error.cmn extend.cmn force.cmn frctbl.i goodob.cmn hender.prm \
         hiddn.cmn inpt.cmn lzero.cmn mdldat.cmn mdlsvl.i mdltbl.i \
...
genfor.o:  agr.cmn stdio.i title.cmn units.cmn
...
getdes.o:  desadj.prm desadj.var descm2.prm descm2.var descmp.prm \
         descmp.var desdgn.prm desdgn.var desfsa.prm desfsa.var desmdl.prm \
         desmdl.var desset.prm desset.var desspc.prm desspc.var dessrs.prm \
         dessrs.var desx11.prm desx11.var desxrg.prm desxrg.var \
         tbltitle.prm
...
histx.o:  error.cmn srslen.prm ssap.prm units.cmn
...
opnfil.o:  error.cmn filext.prm filext.var gmeta.prm gmeta.var notset.prm \
         stdio.i tbllog.prm tbltitle.prm
...
profiler.o:  dirt.i stdio.i units.cmn
...
sigex.o:  acfst.i across.i bench.i buffers.i cmpflts.i cross.i date.i \
         dimensions.i dirs.i error.cmn estb.i force.i func2.i func4.i func5.i \
...
table.o:  desfct.prm desfct.var error.cmn extend.cmn force.cmn goodob.cmn \
         hiddn.cmn missng.cmn notset.prm srslen.prm tbltitle.prm tfmts.cmn \
         tfmts.prm tfmts.var title.cmn units.cmn x11opt.cmn x11ptr.cmn \
         xtrm.cmn
...
x12hdr.o:  agr.cmn build.prm cmptbl.i error.cmn force.cmn hiddn.cmn lex.i \
         mdltbl.i metadata.cmn metadata.prm missng.cmn mq3.cmn notset.prm \
