...
c      spect(1:Lspect): theoretical spectrum of the model for w=(1:Lspect)*pi/Lspect
      ...
      include 'testf1.i'
      real*8 pi
      parameter (pi=3.14159265358793d0)
c     INPUT PARAMETERS
      integer na,ne
...
c     TruncaSpectra: para los espectros te�ricos trunca
c         todos los valores pr�ximos a los picos estacionales y W=0
...
c     TruncaSeasSpect: trunca a un valor m�ximo en la proximidad
...
*c
*c     maxValT nos devuelve el mayor valor no infinito de los m�ximos de los espectros
...
c     CONSTANT PARAMETERS
      real*8 pi
      integer nSG
      parameter(pi=3.141592653589793D0,nSG=120)
c     INPUT PARAMETERS
      integer HPcycle
