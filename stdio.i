...
c-----------------------------------------------------------------------
c ALL     i  PARAMETER for all files to be closed
...
c-----------------------------------------------------------------------
     ...
     &          DOCNAM*16
      parameter(PFILCR=256,VERNUM='1.1',PRGNAM='X-13ARIMA-SEATS',
     &          SPCSEC='Section 7',LIMSEC='Section 2.7',
     &          RUNSEC='Section 2',MDLSEC='Section 5',
     &          DOCNAM='Reference Manual',NPRGNM=15)
      integer ALL,PFILE,STDERR,STDIN,STDOUT,PSRS
cfame
cfame      parameter(ALL=-1,STDERR=6,STDIN=5,STDOUT=6,PFILE=200,
cfame     &          PSRS=500)
cdos
      parameter(ALL=-1,STDIN=5,STDOUT=6,PFILE=10,PSRS=10000)
C
C COMMON variables
C
