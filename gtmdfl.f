C     Last change:  BCM   8 Dec 1998    4:04 pm
      SUBROUTINE gtmdfl(Mdlfil,Mtm,Begsrs,Nobs,Havsrs,Havesp,Userx,
     &                  Nrusrx,Bgusrx,Itdtst,Lmodel,Lestim,Havreg,
...
c-----------------------------------------------------------------------
     ...
     &        Ch2tst,Luser,Elong,Havtca
      INTEGER Begsrs,Nobs,Itdtst,Nrusrx,Bgusrx,nfil,Mtm,iflt,begopr,
     &        endopr,iopr,beglag,endlag,begcol,endcol,ilag,icol,Lomtst,
     &        Eastst,Fcntyp,igrp
      DIMENSION Begsrs(2),Bgusrx(2),Userx(*),Rgaicd(PAICT)
c-----------------------------------------------------------------------
