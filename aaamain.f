C     Last change:  BCM  15 Oct 1998   12:21 pm
...
C-----------------------------------------------------------------------
      ...
      INCLUDE 'nsums.i'
C-----------------------------------------------------------------------
      LOGICAL lmeta,lchkin,rok,lcomp,ldata,lgraf,lexgrf,gmtok,x11agr,fok
...
C-----------------------------------------------------------------------
     ...
     &            ldata,dtafil,lgraf,grfdir,Lcmpaq)
      IF(Lfatal)STOP
C-----------------------------------------------------------------------
      IF(Lwdprt)THEN
